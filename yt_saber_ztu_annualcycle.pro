...
index=where(finite(ubar_yt) ne 1L)
if index(0) ne -1L then ubar_yt(index)=-999.
index=where(finite(zbar_yt) ne 1L)
if index(0) ne -1L then zbar_yt(index)=-999.
    ...
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='yt_saber_tuv+edge_nc5_annualcycle.ps'
       device,/color
...
;
    ...
    for i=0,nday-1L do begin
        ...
        for j=0,nr-1L do begin
            ...
            if index(0) ne -1L then zbar_annual_yt(i,j)=total(zbar(j,index))/float(nn)
        endfor
    ...
    contour,ubar_annual_yt,1.+findgen(nday),alat,charsize=1.5,/noeras,/overplot,levels=[40,60,80,100,120],color=0
    contour,ubar_annual_yt,1.+findgen(nday),alat,charsize=1.5,/noeras,/overplot,levels=-1.*[120,100,80,60,40],color=mcolor,c_linestyle=5
    contour,tbar_annual_yt,1.+findgen(nday),alat,levels=[170.],color=mcolor*.2,/follow,/noeras,/overplot,min_value=0.,thick=5
    contour,tbar_annual_yt,1.+findgen(nday),alat,levels=[230.],color=mcolor*.9,/follow,/noeras,/overplot,min_value=0.,thick=5
loadct,0
...
;
    ...
    contour,ubar_annual_yt,1.+findgen(nday),alat,charsize=1.5,/noeras,/overplot,levels=[40,60,80,100,120],color=0
    contour,ubar_annual_yt,1.+findgen(nday),alat,charsize=1.5,/noeras,/overplot,levels=-1.*[120,100,80,60,40],color=mcolor,c_linestyle=5
    contour,tbar_annual_yt,1.+findgen(nday),alat,levels=[220.],color=mcolor*.2,/follow,/noeras,/overplot,min_value=0.,thick=5
    contour,tbar_annual_yt,1.+findgen(nday),alat,levels=[260.],color=mcolor*.9,/follow,/noeras,/overplot,min_value=0.,thick=5
loadct,0
    markbar_annual_yt=smooth(markbar_annual_yt,7)
    contour,markbar_annual_yt,1.+findgen(nday),glatth,levels=[0.5],color=mcolor*.3,/follow,/noeras,/overplot,min_value=0.,thick=5,c_labels=[0]
loadct,38
print,min(tbar_annual_yt),max(tbar_annual_yt)
    ...
    contour,ubar_annual_yt,1.+findgen(nday),alat,charsize=1.5,/noeras,/overplot,levels=[40,60,80,100,120],color=0
    contour,ubar_annual_yt,1.+findgen(nday),alat,charsize=1.5,/noeras,/overplot,levels=-1.*[120,100,80,60,40],color=mcolor,c_linestyle=5
    contour,tbar_annual_yt,1.+findgen(nday),alat,levels=[240.],color=mcolor*.2,/follow,/noeras,/overplot,min_value=0.,thick=5
    contour,tbar_annual_yt,1.+findgen(nday),alat,levels=[270.],color=mcolor*.9,/follow,/noeras,/overplot,min_value=0.,thick=5
loadct,0
    markbar_annual_yt=smooth(markbar_annual_yt,7)
    contour,markbar_annual_yt,1.+findgen(nday),glatth,levels=[0.5],color=mcolor*.3,/follow,/noeras,/overplot,min_value=0.,thick=5,c_labels=[0]
loadct,38
print,min(tbar_annual_yt),max(tbar_annual_yt)
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert -trim yt_saber_tuv+edge_nc5_annualcycle.ps -rotate -90 '+$
                           'yt_saber_tuv+edge_nc5_annualcycle.jpg'
    endif
end

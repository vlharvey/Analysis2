...
MLS_period = [20020125,20180703] ;based on monthly SABER_Temp_O3 files
...
ncdf_attput, ncid, 'Comment', '(4) SABER monthly SABER_Temp_O3 files version v2 were used, '+str_mls_period, /global
...
file=file_search(mls_obs_path+'SABER_Temp_O3_v2_sathist_2002-2015.sav',count=nfiles)
restore,file
print,file
date_orig=date

...
;
lstmn=2L & lstdy=4L & lstyr=9L
ledmn=2L & leddy=4L & ledyr=9L
lstday=0L & ledday=0L 
...
;
      spawn,'ls '+dir+'MLS-Aura_L2DMP-GEOS5-20_v02-2*'+string(FORMAT='(i4.4,a1,i3.3)',iyr,'d',iday)+'.he5',dmpfiles
      result1=size(dmpfiles)
;
; this logic will jump day if missing file
;
      if result1(0) eq 0L then begin
...
;
      dmp=readl2gpd_std(dmpfiles(0),swathName='DMP-GEOS5-20',variableName=variableName,precisionName=precisionName)
stop
;

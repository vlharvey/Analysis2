...
lstmn=3L & lstdy=1L & lstyr=2007L
ledmn=5L & leddy=3L & ledyr=2007L
lstday=0L & ledday=0L
;
; get date range
;
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='2007+Highs/polar_3d_sh_geos5_meto_'+date+'_DL.ps'
   device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim 2007+Highs/polar_3d_sh_geos5_meto_'+date+'_DL.ps -rotate -90 2007+Highs/polar_3d_sh_geos5_meto_'+date+'_DL.jpg'
    endif
goto, jump
end

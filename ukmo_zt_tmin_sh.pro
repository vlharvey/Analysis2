;
; SH version. plot vortex minimum temperature as a function of altitude and time
;
@rd_ukmo
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='ukmo_tmin_'+y1+'_sh.ps'
   device,/color
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim ukmo_tmin_'+y1+'_sh.ps -rotate -90 ukmo_tmin_'+y1+'_sh.jpg'
endif
endfor
end

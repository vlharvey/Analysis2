...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='yz_wa4_ubarth+mark_'+month(lstmn-1)+'.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
save,file='yz_wa4_ubarth+mark_'+month(lstmn-1)+'.sav',alat,th,tzm,uzm,markzm
;
...
contour,uzm,alat,th,/noeras,xrange=[-90.,90.],yrange=[400.,3000.],color=0,$
      ...
      xtitle='Latitude',title='WACCM-4 '+month(lstmn-1)
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim yz_wa4_ubarth+mark_'+month(lstmn-1)+'.ps -rotate -90 yz_wa4_ubarth+mark_'+month(lstmn-1)+'.jpg'
endif

...
ifile='                             '
lstmn=1 & lstdy=1 & lstyr=4 & lstday=0
...
;
      if setplot eq 'ps' then begin
         ...
         device,/landscape,bits=8,$
                 filename='xz_o3_soundings+mark_nh_'+lfile+'.ps'
         device,/color
...
;
      ...
      if setplot eq 'ps' then begin
         device, /close
         spawn,'convert xz_o3_soundings+mark_nh_'+lfile+'.ps -rotate -90 '+$
               ' XZ_Ozone/xz_o3_soundings+mark_nh_'+lfile+'.jpg'
         spawn,'/usr/bin/rm -f xz_o3_soundings+mark_nh_'+lfile+'.ps'
      endif
stop
      goto,jump
end

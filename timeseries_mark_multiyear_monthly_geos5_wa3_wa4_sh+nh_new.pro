...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='timeseries_mark_multiyear_monthly_'+sth+'_sh+nh.ps'
   !p.charsize=1.5
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
contour,gmarklat(*,*,0),1+findgen(12),alat,/nodata,/noeras,xrange=[1.,12.],yrange=[-90.,-10.],charsize=2,color=0,/cell_fill,c_color=col1,$
      ytitle='Latitude',xticks=n_elements(xlab)-1,xtickname=xlab,levels=level
...
;xyouts,4.5,-85,'SZA=90',/data,color=150,charsize=2,charthick=2
loadct,39
;xyouts,1.2,-34.,'GEOS',/data,color=0,charsize=2,charthick=2
;xyouts,1.2,-24.,'WA-3',/data,color=250,charsize=2,charthick=2
;xyouts,1.2,-29.,'WA-4',/data,color=70,charsize=2,charthick=2
...
index=where(gmarklat eq 0.)
if index(0) ne -1L then gmarklat(index)=0./0.
contour,gmarklat(*,*,0),1+findgen(12),alat,/nodata,/noeras,xrange=[1.,12.],yrange=[10.,90.],charsize=2,color=0,/cell_fill,c_color=col1,$
      ytitle='Latitude',xticks=n_elements(xlab)-1,xtickname=xlab,levels=level
contour,w3marklat(*,*,0),1+findgen(12),alat,/overplot,/follow,levels=[0.5],color=250,thick=15,c_linestyle=0,c_labels=[0]
contour,w4marklat(*,*,0),1+findgen(12),alat,/overplot,/follow,levels=[0.5],color=70,thick=15,c_linestyle=0,c_labels=[0]
contour,gmarklat(*,*,0),1+findgen(12),alat,/overplot,/follow,levels=[0.5],color=0,thick=15,c_linestyle=0,c_labels=[0]
...
;xyouts,4.5,85,'SZA=90',/data,color=150,charsize=2,charthick=2
loadct,39
xyouts,1.2,15.,'GEOS',/data,color=0,charsize=2,charthick=2
xyouts,1.2,30.,'WA-3',/data,color=250,charsize=2,charthick=2
xyouts,1.2,22.5,'WA-4',/data,color=70,charsize=2,charthick=2

if setplot ne 'ps' then stop
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim timeseries_mark_multiyear_monthly_'+sth+'_sh+nh.ps -rotate -90 timeseries_mark_multiyear_monthly_'+sth+'_sh+nh.jpg'
endif
end

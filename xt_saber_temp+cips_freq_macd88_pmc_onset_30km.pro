;
; Hovmoller of SABER temperature 1 May to 1 July
...
; save temp
;
save,file='xt_saber_temp_'+yearlab+'_'+slat+'_pmc_onset_30km.sav',saberpolartp_xt,kday,longrid,sdate_all
quick:
yearlab=string(format='(i4)',iyear)
restore,'xt_saber_temp_'+yearlab+'_'+slat+'_pmc_onset_30km.sav'
sdate0=sdate_all(0)
...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='xt_saber_temp+cips_freq_'+yearlab+'_'+slat+'_pmc_onset_30km.ps'
   !p.charsize=1.55
   !p.thick=2
   !p.charthick=5
   !y.thick=2
...
;axis,yaxis=1,xaxis=1,xrange=[0.,360.],yrange=[-6,-51.],/save,charsize=2	; May 1 to June 15
...
;xyouts,xmn+0.01,ymx-0.05,yearlab+'/'+slat+'N/'+salt+'km',/normal,charsize=2.5,color=0,charthick=2
; 54.3333° N, 10.1333 E DFS -22=May 30
;oplot,[10.13,10.13],[-22,-22],psym=4,color=0,symsize=2,thick=3
loadct,39
...
x1=x1+dx
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert -trim xt_saber_temp+cips_freq_'+yearlab+'_'+slat+'_pmc_onset_30km.ps -rotate -90 xt_saber_temp+cips_freq_'+yearlab+'_'+slat+'_pmc_onset_30km.png'
    endif

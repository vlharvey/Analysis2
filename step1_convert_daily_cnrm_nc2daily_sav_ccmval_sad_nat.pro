;
; read nc files from Doug Kinnison of Surface Area Density of NAT
; /aura7/harvey/CCMval_data/Datfiles/CCMVal2_REF-B1_CNRM-ACM_2_T3I_nat_*nc
;
; NOTE: time:units = "hours since 1990-01-01 00:00" and units are m-1
;
; 10 day instantaneous fields
;
dir='/aura7/harvey/CCMval_data/Datfiles/CCMVal2_REF-B1_CNRM-ACM_2_T3I_sad_nat'

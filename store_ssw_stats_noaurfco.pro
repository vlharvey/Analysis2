;
; noaurfco run
; store number of major and minor ssw per year.  use standard WMO definition
;
@stddat
@kgmt
@ckday
...
nhu60=nhu60(index,*)
shu60=shu60(index,*)
save,file='waccm_noaurfco_wmo_ssw_diagnostics.sav',yyyymmdd,lev,nhdt,shdt,nhu60,shu60

...
xyouts, .12,.95,'WACCM 60 N GPH Wave 2 Amplitude - event ' + strtrim(strcompress(ies+1L),2) + ' -- ' + dates[idayzero]
...
loadct, 39
  ...
  if setplot eq 'ps' then begin
	...
	'pnmtopng idl001.ppm > /Volumes/MacD68-1/france/ES_paper/Figures/WACCM_PW_2_Amp_event_'+strtrim(strcompress(ies+1L),2)+'.png'

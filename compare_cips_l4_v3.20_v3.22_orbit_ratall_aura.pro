...
;
spawn,'ls /aura7/harvey/CIPS_data/Datfiles/cips_sci_4_orbit_*_2007-148*_v03.20.nc',fnames20_all
...
sorbit=result2(4)
sdate=result2(5)
dum=findfile('/aura7/harvey/CIPS_data/Datfiles/cips_sci_4_orbit_'+sorbit+'_'+sdate+'_v03.22.nc')
dum2=findfile('/aura7/harvey/CIPS_data/Datfiles/cips_sci_4_ozo_orbit_'+sorbit+'_'+sdate+'_v03.20.nc')
dum3=findfile('/aura7/harvey/CIPS_data/Datfiles/cips_sci_4_ozo_orbit_'+sorbit+'_'+sdate+'_v03.22.nc')
if dum(0) eq '' or dum2(0) eq '' or dum3(0) eq '' then goto,skiporbit
fname22='/aura7/harvey/CIPS_data/Datfiles/cips_sci_4_orbit_'+sorbit+'_'+sdate+'_v03.22.nc'
print,sorbit+' '+sdate

...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='polar_3d_sh_waccm3_'+sdate+'_DL+highs_nc4.ps'
   device,/color
...
jumplev:
    ...
    !psym=0
    xyouts,0.25,0.875,'WACCM3 Antarctic Vortex',/normal,charsize=3,color=0,charthick=2
    xyouts,0.4,0.84,'(Max Jet Speed)',/normal,charsize=2,color=0,charthick=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim polar_3d_sh_waccm3_'+sdate+'_DL+highs_nc4.ps -rotate -90 '+$
                           'polar_3d_sh_waccm3_'+sdate+'_DL+highs_nc4.jpg'
       spawn,'/usr/bin/rm -f polar_3d_sh_waccm3_'+sdate+'_DL+highs_nc4.ps'
    endif

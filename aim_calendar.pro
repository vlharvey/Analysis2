...
Function aim_Calendar, year,month_number
    ;December causes a problem because the program looks to month 13
	If month_number eq 12 then begin
	   number_of_days=31
	Endif Else begin
	   number_of_days=(ymd2yd([year,month_number+1,1])-ymd2yd([year,month_number,1]))[0]
	Endelse
	start_day=(ymd2yd([year,month_number,1]))[0]
	...
	first_sunday=2454107+((year-2007)*7*52)

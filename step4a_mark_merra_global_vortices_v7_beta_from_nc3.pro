...
lstmn=10 & lstdy=1 & lstyr=2014 & lstday=0
ledmn=1 & leddy=31 & ledyr=2015 & ledday=0
;
...
;
      ...
      date=syr+smn+sdy
      uyr=strmid(syr,2,2)
      ifile=string(FORMAT='(i4.4,i2.2,i2.2)',iyr,imn,idy)
      print,ifile
      rd_merra_nc3,dir+ifile+'.nc3',nc,nr,nth,alon,alat,th,pv2,p2,$

;
; save daily maximum Temperature poleward of 45 degrees for MetO record
...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   set_plot,'ps'
   device,/color,/landscape,bits=8,filename='timeseries_polarT_'+slev+'K.ps'
...
plot,findgen(ndoy),nh_polart_mean,ytitle='Temperature',yrange=[imin,imax],$
     ...
     title='MetO Maximum Temperature at '+slev+' K'
for idoy=0L,ndoy-1L do begin
...
oplot,fdoy(index)-181,NH_POLART_LEV(index),color=250,thick=5
xyouts,10.,185.,'2008-2009',color=250,/data,charsize=2,charthick=1.5

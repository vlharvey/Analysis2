;
; ERA40 zonal mean andticyclone area (all latitudes) for 45 year record
;
; VLH 9/26/09
;
@stddat
...
ledmn=2L & leddy=28L & ledyr=1991L
;
...
nday=icount
save,file='ERA40_antic_area_alllat_'+yearlab+'.sav',nth,nr,alat,nday,yyyymmdd_all,th,markbar_all
end

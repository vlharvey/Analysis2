pro write_geos5_nc3_brakebusch,ofile,nlg,nlat,nth,alon,alat,thlev,$
...
vpfid  = ncdf_vardef(ncid, 'velpot'    , [latdimid,londimid,levdimid])
...
ncdf_varput, ncid, vpfid , vp   , COUNT=[nlat,nlg,nth]
ncdf_close,ncid
return
end

...
gph2_comp=gph2_comp/float(nevents)
ttgw2_comp=ttgw2_comp/float(nevents)
sf2_comp=sf2_comp/float(nevents)
mark2_comp=mark2_comp/float(nevents)
save,filename='/Users/harvey/Harvey_etal_2014/Post_process/SSW_composite_days_waccm_dm30-dp30.sav',alon,alat,th,nc,nr,nth,pv2_comp,p2_comp,u2_comp,v2_comp,qdf2_comp,q2_comp,gph2_comp,ttgw2_comp,sf2_comp,mark2_comp
end

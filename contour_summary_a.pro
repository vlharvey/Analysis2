...
DEVICE,/BOLD
DEVICE, FILENAME=PTHo+'A_V4.20_'+season+'_'+G+'G.ps'
...
SUBTITLE=SUBTI,title='Ascending Albedo'

POS=[0.95,0.20,1.00,0.775]
COLOR_PANEL_INTEGER,POS,FLEV,COL,-0.00,1.4
XYOUTS,0.975,0.855,'10!u-6!nsr!u-1!n',/NORMAL,CHARSIZE=1.2,ALIGNMENT=0.5

contour,array(*,35:69),Ddd,lat(35:69),c_colors=col,levels=flev,/cell_fill, $
SUBTITLE=SUBTI,title='Descending Albedo'
...
title='Asc Minus Desc Albedo',SUBTITLE=SUBTI
COLOR_PANEL_INTEGER,POS,FLEV,COL,-0.00,1.4
XYOUTS,0.975,0.855,'10!u-6!nsr!u-1!n',/NORMAL,CHARSIZE=1.2,ALIGNMENT=0.5

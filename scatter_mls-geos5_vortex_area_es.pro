...
;
    if setplot eq 'ps' then begin
       ...
       device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
              /bold,/color,bits_per_pixel=8,/times,filename='../Figures/scatter_geos5_vortex_area_ES_event_'+sevent+'_'+slev+'K.ps'
       !p.charsize=1.25
       !p.thick=2
       !p.charthick=5
       !p.charthick=5
...
plot,1.+findgen(40),th,color=0,xtitle='GEOS5 Vortex Area (% NH) at '+slev+' K',xrange=[0.,40.],yrange=[500.,10000.],/noeras,ytitle='Polar Cap Mean Stratopause Theta (K)',$
     title='MLS ES event '+sevent+' ('+esdate(30+ndays*(ies))+')',/nodata
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim ../Figures/scatter_geos5_vortex_area_ES_event_'+sevent+'_'+slev+'K.ps -rotate -90 ../Figures/scatter_geos5_vortex_area_ES_event_'+sevent+'_'+slev+'K.jpg'
endif

;
; daily zonal mean MLS temperature
;
@stddat
@kgmt
@ckday
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='yz_mls_temp_'+sdate+'.ps'
   device,/color
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim yz_mls_temp_'+sdate+'.ps -rotate -90 yz_mls_temp_'+sdate+'.jpg'
   spawn,'/usr/bin/rm -f yz_mls_temp_'+sdate+'.ps'
endif
goto,jump
end

...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='timeseries_mark_multiyear_monthly_'+sth+'.ps'
   !p.charsize=1.5
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
contour,gmarklat,1+findgen(12),alat,/nodata,/noeras,xrange=[1.,12.],yrange=[20.,90.],charsize=2,color=0,/cell_fill,c_color=col1,$
      ytitle='Latitude',xticks=n_elements(xlab)-1,xtickname=xlab,title='Arctic Vortex at '+sth,levels=level
...
xyouts,1.2,37.5,'SZA=90',/data,color=150,charsize=2
loadct,39
xyouts,1.2,32.5,'GEOS-5',/data,color=0,charsize=2
xyouts,1.2,27.5,'WACCM-3',/data,color=250,charsize=2
xyouts,1.2,22.5,'WACCM-4',/data,color=100,charsize=2

if setplot ne 'ps' then stop
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim timeseries_mark_multiyear_monthly_'+sth+'.ps -rotate -90 timeseries_mark_multiyear_monthly_'+sth+'.jpg'
endif
end

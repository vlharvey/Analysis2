...
;
      if setplot eq 'ps' then begin
         ...
         device,/landscape,bits=8,$
                 filename='xz_o3_soundings+mark_sh_'+lfile+'.ps'
         device,/color
...
;
      ...
      if setplot eq 'ps' then begin
         device, /close
         spawn,'convert xz_o3_soundings+mark_sh_'+lfile+'.ps -rotate -90 '+$
               ' XZ_Ozone/xz_o3_soundings+mark_sh_'+lfile+'.jpg'
         spawn,'/usr/bin/rm -f xz_o3_soundings+mark_sh_'+lfile+'.ps'
      endif
      goto,jump
end

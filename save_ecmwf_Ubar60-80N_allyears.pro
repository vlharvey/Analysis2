;
; save daily zonal mean zonal wind between 60 and 80N for all levels and years
;
@stddat
@kgmt
@ckday
...
;
      ...
      if icount eq 0L then begin
         ...
         ubar_60to80N_all=fltarr(nyear,kday,nth)
...
;
      ...
      for thlev=0,nth-1 do begin
          ...
          index=where(lat ge 60. and lat le 80.,nn)
          ubar_60to80N_all(myr,iday,thlev)=total(u(index))/float(nn)
      endfor
goto,jump
saveit:
save,file='ecmwf_Ubar60to80N_allyears.sav',ubar_60to80N_all,th,yyyymmdd,doy
end

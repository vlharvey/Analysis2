;
; save multi-year monthly means of CNRM Surface Area Density of ice
...
for imon=0L,nmon-1L do begin
    ...
    dir='/aura7/harvey/CCMval_data/Datfiles/CCMVal2_REF-B1_CNRM-ACM_2_T3I_sad_ice_????'+smon(imon)+'??.sav'
...
; save monthly mean
;
    save,file='/aura7/harvey/CCMval_data/Datfiles/CCMVal2_REF-B1_CNRM-ACM_2_T3I_sad_ice_'+smon(imon)+'.sav',$
          alon,alat,lev,wsadgrd,nwsadgrd
    print,'saved CCMVal2_REF-B1_CNRM-ACM_2_T3I_sad_ice_'+smon(imon)+'.sav'
endfor
end

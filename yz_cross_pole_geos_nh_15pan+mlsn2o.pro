...
if mco(iprof,kk) ne -9.90000e+10 and mco(iprof,kk+1) ne -9.90000e+10 then begin
...
;
    ...
    if setplot eq 'ps' then begin
       ...
       ysize=nydim/100.
       set_plot,'ps'
       device,/color,/landscape,bits=8,filename='yz_cross_pole_geos_nh_'+sdate+'_'+slon1+'_15pan+mlsn2o.ps'
...
index=where(yyz lt 3000)
    ...
    contour,tyz,alat,th,levels=level,/cell_fill,c_color=col1,color=0,title='Temperature',$
            ...
            xtickname=['Eq','30','60','NP','60','30','Eq'],xticks=6,yrange=[500.,3000.]
...
index=where(yyz lt 3000)
    ...
    int=(imax-imin)/float(nlvls)
    level=imin+int*findgen(nlvls)
    contour,sfyz,alat,th,levels=level,/cell_fill,c_color=col1,color=0,title='SF+N2O',$
            xtitle=slon1+'       '+slon2,ytickname=[' ',' ',' ',' ',' ',' ',' ',' '],$
            xtickname=['Eq','30','60','NP','60','30','Eq'],xticks=6,yrange=[500.,3000.]
...
;   contour,spyz,alat,th,levels=[75.],/overplot,/follow,color=mcolor,thick=2,c_labels=['']
    ...
    axis,xrange=[0.,n_elements(mlon_swath)-1L],yrange=[500.,3000.],/save,/data
    mco_swath=smooth(mco_swath,9)
;
; N2O
;
    contour,mco_swath,findgen(n_elements(mlon_swath)),th,levels=[1.,2.,5.,10.,20.,50.,100.],$
            /follow,c_color=mcolor,/overplot,thick=5
...
; Close PostScript file and return control to X-windows
     ...
     if setplot eq 'ps' then begin
        device, /close
        spawn,'convert -trim yz_cross_pole_geos_nh_'+sdate+'_'+slon1+'_15pan+mlsn2o.ps -rotate -90 '+$
                            'yz_cross_pole_geos_nh_'+sdate+'_'+slon1+'_15pan+mlsn2o.jpg'
        spawn,'/usr/bin/rm yz_cross_pole_geos_nh_'+sdate+'_'+slon1+'_15pan+mlsn2o.ps'
     endif
     jumpday:
goto,jump
end

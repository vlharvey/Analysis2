...
;dirh='/Volumes/earth/aura3/data/WACCM_data/Datfiles/noaurfcoaverageYear_'
dirh='/Volumes/earth/aura3/data/WACCM_data/Datfiles/noaurfplaverageYear_'
lstmn=1 & lstdy=1 
lstmn=11 & lstdy=21
ledmn=12 & leddy=31 
;
...
; streamfunction based anticyclone marker
          markh=0.*qdf
;         marker_highs_v6,sf,markh,qdf,zeta,u,v,x,xlat	; skip due to time constraint
;
...
erase
!type=2^2+2^3
contour,sf,x,xlat,nlevels=20,/noeras,thick=3,title=string(long(theta))+' K'
...
if index(0) ne -1 then oplot,x2d(index),y2d(index),psym=4,color=.3*mcolor

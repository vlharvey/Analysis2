...
if iday ge 31L then kyr=iyr+1L
    ...
    ifile=smn+'_'+sdy+'_'+syr
if iyr ge 2003L then ifile=syr+smn+sdy
    lfile=nmon(imn-1)+'_'+sdy+'_'+uyr
    dum=findfile(diru+ifile+'_12Z.nc3')
    if dum(0) eq '' then goto,skipday
    ncid=ncdf_open(diru+ifile+'_12Z.nc3')
    print,ifile
...
save,file='ecmwf_Tnat_area_allyears.sav',area_ave,years,th,sfile
end

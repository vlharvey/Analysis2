...
; Input data:  IDL> restore,'/Volumes/earth/aura3/data/WACCM_data/Datfiles/mee00fco.vars.h3.YYYYMMDD.sav'
...
thlev=[4000.,3500.,3000.,2750.,2500.,2250.,2000.,1800.,1600.,1400.,1200.,1000.,900.,800.,700.,600.,500.]
...
dirw='/Volumes/earth/aura3/data/WACCM_data/Datfiles/mee00fco.vars.h3.'
...
tgrd=reform(tgrd(*,*,13:50))
vgrd=reform(vgrd(*,*,13:50))
ugrd=reform(ugrd(*,*,13:50))
pgrd=reform(pgrd(*,*,13:50))
nc=n_elements(alon)
nr=n_elements(alat)
result=size(tgrd)
nl=result(3)

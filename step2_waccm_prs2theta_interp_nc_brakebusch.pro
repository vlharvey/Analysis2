...
dirw='/aura7/harvey/WACCM_data/Datfiles/Datfiles_Brakebusch/wcm_geos_50-60km_daily_2x_0.1rlx.'
...
tgrd=reform(tgrd(*,*,35:60))
vgrd=reform(vgrd(*,*,35:60))
ugrd=reform(ugrd(*,*,35:60))
pgrd=reform(pgrd(*,*,35:60))
nc=n_elements(alon)
nr=n_elements(alat)
result=size(tgrd)
nl=result(3)

...
; Superimpose MLS N2O contours
; Superimpoase HIRDLS N2O contours
;
@stddat
@kgmt
@ckday
...
;
      ...
      for ii=0L,n_elements(id)-1L do begin
          if latitude(ii) ge 60. then begin
             ...
             good=where(n2o_prof ne -99. and n2o_prof lt 1.e-6,ngood)
             if good(0) ne -1L then begin
...
plot,polarn2o,altitude,color=0,/noerase,title='N!l2!nO',xrange=[5.e-8,1.e-6],/xlog
;
...
;
      ...
      if good(0) ne -1L then print,polarn2o(good)/mlspolarn2o(good)
...
save,file='zt_hirdls_polarno2_n2o+mlsn2o_2006.sav',polart_zt,polarno2_zt,polarn2o_zt,$
     mlspolarn2o_zt,kday,altitude,sdate_all
quick:
restore,'zt_hirdls_polarno2_n2o+mlsn2o_2006.sav'
sdate0=sdate_all(0)
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='zt_hirdls_polarno2_n2o+mlsn2o_'+syear(0)+'.ps'
   device,/color
   device,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize
endif
;
; plot Arctic mean NO2, N2O, MLS N2O
;
erase
xmn=xorig(0)
xmx=xorig(0)+xlen
...
contour,polarno2_zt,1.+findgen(kday),altitude,/noeras,xrange=[1.,kday],yrange=[25.,57.],$
      charsize=1.5,color=0,ytitle='Altitude (km)',title='HIRDLS Avg NO!l2!n and N!l2!nO and MLS N!l2!nO > 60 N',/fill,c_color=col1,$
...
contour,mlspolarn2o_zt,1.+findgen(kday),altitude,levels=[0.01,0.015,0.02,0.03,0.05],color=0,/follow,/overplot,$
        min_value=0.,c_labels=[1,1,1,1,1],thick=5
contour,polarn2o_zt,1.+findgen(kday),altitude,levels=[0.1,0.2,0.3,0.5],color=mcolor,/follow,/overplot,$
        min_value=0.,c_labels=[1,1,1,1,1],thick=5
...
x1=x1+dx
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert -trim zt_hirdls_polarno2_n2o+mlsn2o_'+syear(0)+'.ps -rotate -90 zt_hirdls_polarno2_n2o+mlsn2o_'+syear(0)+'.jpg'
    endif
end

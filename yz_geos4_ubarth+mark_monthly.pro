...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='yz_geos4_ubarth+mark_'+sdate0+'-'+sdate1+'.ps'
   device,/color
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim yz_geos4_ubarth+mark_'+sdate0+'-'+sdate1+'.ps -rotate -90 yz_geos4_ubarth+mark_'+sdate0+'-'+sdate1+'.jpg'
endif

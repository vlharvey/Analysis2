;
; Read in Level 2a RAA filtered data and plot daily global map
; VLH 8/28/18
;    
@stddat
@kgmt
...
;
      ...
      if setplot eq 'ps' then begin
         ...
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
                /bold,/color,bits_per_pixel=8,/helvetica,filename='cips_raa_level2a_daily_global_'+sdate+'.ps'
         !p.charsize=1.25
         !p.thick=2
         !p.charthick=5
         !y.thick=2
      ...
      map_set,0,0,0,/merc,/contin,/grid,title=sdate,color=0,/noerase,limit=[-30.,0.,-65.,360.]
...
;     slab=string(format='(f4.1)',level(0:-1:2))
      ...
      if setplot eq 'ps' then begin
         device, /close
         spawn,'convert -trim cips_raa_level2a_daily_global_'+sdate+'.ps -rotate -90 cips_raa_level2a_daily_global_'+sdate+'.png'
;        spawn,'rm -f cips_raa_level2a_daily_global_'+sdate+'.ps'
      endif

...
!noeras=1
dir='/aura6/data/GEOS4_data/Datfiles/DAS.flk.asm.tavg3d_mis_e.GEOS403.MetO.'
lstmn=5L & lstdy=15L & lstyr=2007L
ledmn=5L & leddy=15L & ledyr=2007L
lstday=0L & ledday=0L
;
; get date range
;
...
print,'Read GEOS-4 data on '+date
      x=fltarr(nc+1)
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='polar_3d_sh_geos4_meto_'+date+'_DL+highs_nc4.ps'
   device,/color
...
jumplev:
    ...
    !psym=0
    xyouts,0.25,0.9,'Antarctic Vortex in GEOS-4',/normal,charsize=3,color=0,charthick=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim polar_3d_sh_geos4_meto_'+date+'_DL+highs_nc4.ps -rotate -90 polar_3d_sh_geos4_meto_'+date+'_DL+highs_nc4.jpg'
    endif
goto, jump
end

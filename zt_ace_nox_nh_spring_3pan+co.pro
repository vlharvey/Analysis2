...
;  !p.font=0
   !p.charthick=3
   device,font_size=8
   device,/landscape,bits=8,filename='zt_ace_nox_nh_spring_3pan+co.ps'
   device,/color
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim zt_ace_nox_nh_spring_3pan+co.ps -rotate -90 zt_ace_nox_nh_spring_3pan+co.jpg'
endif
end

...
; save 
;
save,file='xt_mls_h2o_'+yearlab+'_'+slat+'_pmc_onset_40km.sav',mlspolarh2o_xt,kday,longrid,sdate_all
quick:
restore,'xt_mls_h2o_'+yearlab+'_'+slat+'_pmc_onset_40km.sav'
sdate0=sdate_all(0)
...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='xt_mls_h2o_'+yearlab+'_'+slat+'_pmc_onset_40km.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !y.thick=2
...
tlevel=6.5+.025*findgen(21)
nlvls=n_elements(tlevel)
col1=1+indgen(nlvls)*icolmax/nlvls
contour,mlspolarh2o_xt,longrid,findgen(kday),/noeras,yrange=[kday-1,0.],xrange=[0.,360.],$
      charsize=1.5,color=0,xtitle='Longitude',/cell_fill,c_color=col1,title=yearlab+' Lat= '+slat+' 40km',$
...
x1=x1+dx
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert -trim xt_mls_h2o_'+yearlab+'_'+slat+'_pmc_onset_40km.ps -rotate -90 xt_mls_h2o_'+yearlab+'_'+slat+'_pmc_onset_40km.png'
    endif

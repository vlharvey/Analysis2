...
ntimes=long(kday*48.)
dir='/Volumes/data/WACCM/no_aur.cam2.h1.'
...
;
saveit:
save,file='waccm_no_data_baseline.sav',no_data,lon,lat,lev,sdate_all
save,file='waccm_no2_data_baseline.sav',no2_data,lon,lat,lev,sdate_all
save,file='waccm_o3_data_baseline.sav',o3_data,lon,lat,lev,sdate_all
save,file='waccm_o2_data_baseline.sav',o2_data,lon,lat,lev,sdate_all
save,file='waccm_o_data_baseline.sav',o_data,lon,lat,lev,sdate_all
save,file='waccm_gp_data_baseline.sav',gp_data,lon,lat,lev,sdate_all
save,file='waccm_co_data_baseline.sav',co_data,lon,lat,lev,sdate_all
save,file='waccm_tp_data_baseline.sav',tp_data,lon,lat,lev,sdate_all
save,file='waccm_u_data_baseline.sav',u_data,lon,lat,lev,sdate_all
save,file='waccm_v_data_baseline.sav',v_data,lon,lat,lev,sdate_all
save,file='waccm_z_data_baseline.sav',z_data,lon,lat,lev,sdate_all
end

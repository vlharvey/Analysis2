...
ntimes=long(kday*48.)
dir='/Volumes/data/WACCM/no_aur_smin.cam2.h1.'
...
;
saveit:
save,file='waccm_no_data_baseline_smin.sav',no_data,lon,lat,lev,sdate_all
save,file='waccm_no2_data_baseline_smin.sav',no2_data,lon,lat,lev,sdate_all
save,file='waccm_o3_data_baseline_smin.sav',o3_data,lon,lat,lev,sdate_all
save,file='waccm_o2_data_baseline_smin.sav',o2_data,lon,lat,lev,sdate_all
save,file='waccm_o_data_baseline_smin.sav',o_data,lon,lat,lev,sdate_all
save,file='waccm_gp_data_baseline_smin.sav',gp_data,lon,lat,lev,sdate_all
save,file='waccm_co_data_baseline_smin.sav',co_data,lon,lat,lev,sdate_all
save,file='waccm_tp_data_baseline_smin.sav',tp_data,lon,lat,lev,sdate_all
save,file='waccm_u_data_baseline_smin.sav',u_data,lon,lat,lev,sdate_all
save,file='waccm_v_data_baseline_smin.sav',v_data,lon,lat,lev,sdate_all
save,file='waccm_z_data_baseline_smin.sav',z_data,lon,lat,lev,sdate_all
end

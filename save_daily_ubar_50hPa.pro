...
sdate=strarr(kday)
ofile='/Volumes/earth/harvey/UKMO_data/Datfiles/ukmo_12Z_Ubar_50hPa.sav'
icount=0L
;
...
;
      ...
      if zindex(0) ne -1L then begin
         for j=0L,nr-1L do ubar(j,icount)=total(u3d(*,j,zindex(0)))/float(nc)
      endif
      plot,wlat,ubar(*,icount),xrange=[-90.,90.],yrange=[-40.,80.],title=date,xtitle='Latitude',ytitle='Ubar (m/s)',charsize=2,charthick=2,xticks=6

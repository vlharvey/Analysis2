...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   set_plot,'ps'
   device,/color,/landscape,bits=8,filename='timeseries_merra_vortexarea_'+'_'+salt+'.ps'
...
imin=0.
imax=40.
ubarlev=reform(area1(*,ialt))
plot,dayno,ubarlev,color=col1(iyear),ytitle='MERRA Vortex Area at '+slat+' N',yrange=[imin,imax],charsize=1.5,thick=1,/nodata	;,xrange=[60.,180]
...
xyouts,150.,imax-10,'1994',charsize=2,color=col1(15),/data,charthick=2
xyouts,150.,imax-14,'1997',charsize=2,color=col1(18),/data,charthick=2
xyouts,150.,imax-18,'2008',charsize=2,color=col1(10),/data,charthick=2
xyouts,150.,imax-22,'2011',charsize=2,color=col1(29),/data,charthick=2
xyouts,150.,imax-26,'2013',charsize=2,color=col1(34),/data,charthick=2
plots,134,0.
...
; Close PostScript file and return control to X-windows
     ...
     if setplot eq 'ps' then begin
        device, /close
        spawn,'convert -trim timeseries_merra_vortexarea_'+salt+'.ps -rotate -90 '+$
                            'timeseries_merra_vortexarea_'+salt+'.jpg'
     endif

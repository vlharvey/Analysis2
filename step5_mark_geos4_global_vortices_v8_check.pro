...
lstmn=10 & lstdy=7 & lstyr=6 & lstday=0
ledmn=10 & leddy=7 & ledyr=6 & ledday=0
;
...
; loop over theta
      ...
      for thlev=0,nth-1 do begin
          theta=th(thlev)
          markold1=transpose(marksave2(*,*,thlev))
...
;     write_ukmo_nc3,ifile+'_1200.V01.nc3',nc,nr,nth,xlon,xlat,th,$

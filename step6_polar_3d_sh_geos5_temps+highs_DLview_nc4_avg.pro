...
;
      ...
      date=syr+smn+sdy
      rd_geos5_nc3,dir+date+'_avg.V01.nc3',nc,nr,nth,alon,alat,th,$
...
;
      ncid=ncdf_open(dir+date+'_avg.V01.nc4')
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename=odir(0)+'polar_3d_sh_geos5_meto_'+date+'_DL+highs_nc4_avg.ps'
   device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim '+odir(0)+'polar_3d_sh_geos5_meto_'+date+'_DL+highs_nc4_avg.ps -rotate -90 '+$
                              odir(0)+'polar_3d_sh_geos5_meto_'+date+'_DL+highs_nc4_avg.jpg'
    endif
goto, jump
end

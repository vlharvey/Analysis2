...
; /bold,/color,bits_per_pixel=8,/helvetica,filename=RAA_Plot_filename_ps,decompose=0
	...
	RAA_Plot_filename = outpath+'RAA_Level2b_v01.1_rev04_Orbit-'+strOrbits[iorbit]+'_'+UT_DATE_ORBIT_START+'_contour.png'
	RAA_Plot_filename_60 = outpath+'small_RAA_Level2b_v01.1_rev04_Orbit-'+strOrbits[iorbit]+'_'+UT_DATE_ORBIT_START+'_contour.png'

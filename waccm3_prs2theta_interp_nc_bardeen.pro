...
; Input data:  IDL> restore,'../Datfiles/h0.lynn.20340731_00Z.sav
...
spawn,'ls '+dirw+'h0.lynn.*.sav',ifiles
...
FOR n=0l,nfile-1l DO BEGIN
    ...
    sdate=result3(2)
    restore,dirw+'h0.lynn.'+sdate+'_00Z.sav'
    nc=n_elements(alon)
    nr=n_elements(alat)
    result=size(tgrd)
    nl=result(3)
...
;
ofile='/aura3/data/WACCM_data/Datfiles/h0.lynn.'+sdate+'_00Z.nc'
print,'writing ',ofile

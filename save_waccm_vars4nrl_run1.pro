...
;
saveit:
save,file='waccm_no_data_run1.sav',no_data,lon,lat,lev,sdate_all
save,file='waccm_no2_data_run1.sav',no2_data,lon,lat,lev,sdate_all
save,file='waccm_o3_data_run1.sav',o3_data,lon,lat,lev,sdate_all
save,file='waccm_o2_data_run1.sav',o2_data,lon,lat,lev,sdate_all
save,file='waccm_o_data_run1.sav',o_data,lon,lat,lev,sdate_all
save,file='waccm_gp_data_run1.sav',gp_data,lon,lat,lev,sdate_all
save,file='waccm_co_data_run1.sav',co_data,lon,lat,lev,sdate_all
save,file='waccm_tp_data_run1.sav',tp_data,lon,lat,lev,sdate_all
save,file='waccm_u_data_run1.sav',u_data,lon,lat,lev,sdate_all
save,file='waccm_v_data_run1.sav',v_data,lon,lat,lev,sdate_all
save,file='waccm_z_data_run1.sav',z_data,lon,lat,lev,sdate_all
end

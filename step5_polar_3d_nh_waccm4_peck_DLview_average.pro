...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='Figures/wa4_peck_avg_'+sdate+'.ps'
       device,/color
...
;   xyouts,.08,.8,'Theta (K)',charsize=2,/normal,color=0,charthick=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim Figures/wa4_peck_avg_'+sdate+'.ps -rotate -90 Figures/wa4_peck_avg_'+sdate+'.jpg'
       spawn,'rm -f Figures/wa4_peck_avg_'+sdate+'.ps'
    endif

...
ledmn=12L & leddy=10L & ledyr=2008L
lstday=0L & ledday=0L
...
contour,tzm,alat,th,levels=tlevel(index),color=0,/follow,/overplot,c_labels=1+0*index
...
contour,uzm,alat,th,levels=slevel(index),color=mcolor,/follow,/overplot
index=where(slevel lt 0.)
contour,uzm,alat,th,levels=slevel(index),color=0,/follow,/overplot
...
index=where(slevel gt 0.)
contour,uzmn,alat,thn,levels=slevel(index),color=mcolor,/follow,/overplot
index=where(slevel lt 0.)

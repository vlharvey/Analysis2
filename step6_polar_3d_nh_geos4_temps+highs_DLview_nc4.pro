...
lstmn=9L & lstdy=1L & lstyr=2006L
ledmn=3L & leddy=13L & ledyr=2007L
lstday=0L & ledday=0L
;
; get date range
;
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='polar_3d_nh_geos4_meto_'+date+'_DL+highs_nc4.ps'
   device,/color
...
jumplev:
    ...
    !psym=0
    xyouts,0.25,0.875,'Arctic Vortex in GEOS-4',/normal,charsize=3,color=0,charthick=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim polar_3d_nh_geos4_meto_'+date+'_DL+highs_nc4.ps -rotate -90 polar_3d_nh_geos4_meto_'+date+'_DL+highs_nc4.jpg'
    endif
goto, jump
end

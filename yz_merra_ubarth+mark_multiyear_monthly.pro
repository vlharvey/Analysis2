...
;
quick:
;restore,'yz_merra_ubarth+mark_multiyear_'+smn+'.sav'	;,alat,th,tzm,uzm,markzm
...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='yz_merra_ubarth+mark_multiyear_'+smn+'.ps'
   !p.charsize=1.25
   !p.thick=2
   !p.charthick=5
   !p.charthick=5
...
contour,uzm,alat,th,/noeras,xrange=[-90.,90.],yrange=[400.,5000.],charsize=2,color=0,$
      ytitle='Potential Temperature (K)',xticks=6,/cell_fill,c_color=col1,levels=level,min_value=-9999.,$
      xtitle='Latitude',title='MERRA '+month(ii),charthick=2
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim yz_merra_ubarth+mark_multiyear_'+smn+'.ps -rotate -90 yz_merra_ubarth+mark_multiyear_'+smn+'.jpg'
endif
save,file='yz_merra_ubarth+mark_multiyear_'+smn+'.sav',alat,th,tzm,uzm,markzm

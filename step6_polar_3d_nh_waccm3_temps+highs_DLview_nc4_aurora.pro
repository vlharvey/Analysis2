...
lstmn=1L & lstdy=1L & lstyr=95
ledmn=1L & leddy=31L & ledyr=95
lstday=0L & ledday=0L
;
; get date range
;
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='polar_3d_nh_waccm3_'+sdate+'_DL+highs_nc4.ps'
   device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim polar_3d_nh_waccm3_'+sdate+'_DL+highs_nc4.ps -rotate -90 '+$
                           'polar_3d_nh_waccm3_'+sdate+'_DL+highs_nc4.jpg'
       spawn,'/usr/bin/rm -f polar_3d_nh_waccm3_'+sdate+'_DL+highs_nc4.ps'
    endif

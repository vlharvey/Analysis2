...
;
lstmn=6L & lstdy=15L & lstyr=8L
ledmn=7L & leddy=24L & ledyr=8L
lstday=0L & ledday=0L 
...
;
      bromls=0.*transpose(o3.L2GPVALUE)
      broprecision=-99.+0.*transpose(o3.L2GPPRECISION)
      brostatus=0.*o3.STATUS
      broquality=0.*o3.QUALITY
      broconvergence=0.*o3.CONVERGENCE
      bromask=-99.+0.*bromls

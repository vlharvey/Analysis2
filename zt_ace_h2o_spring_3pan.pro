...
; plot time-altitude section of vortex H2O
;
@fillit
@smoothit
...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='zt_ace_h2o_spring_3pan.ps'
   device,/color
...
; store save file
;
    save,file='vortex_h2o_'+syear(iyear)+'.sav',nday,fdoy,altitude,latitude,oco
;
; postscript file
;
    !type=2^2+2^3
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim zt_ace_h2o_spring_3pan.ps -rotate -90 zt_ace_h2o_spring_3pan.jpg'
endif
end

...
output_path='C:\Users\jope9587\Desktop\Sathist\'
...
mls_obs_path='Z:\Brakebusch\MLS3\original he5\' ;this path contains cat !!!
...
ncid = ncdf_create(output_path+'sat_hist_'+start_date+'-'+end_date+'_MLS_c'+today()+'.nc',/clobber)
  ...
  ncdf_attput, ncid, 'prof_num', '(1) MLS: OrbitGeodeticAngle*10', /global

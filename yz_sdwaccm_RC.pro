...
;
    if setplot eq 'ps' then begin
       ...
       device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
              /bold,/color,bits_per_pixel=8,/times,filename='yz_sdwaccm_tbar_RC_'+sdate+'.ps'
       !p.charsize=1.25
       !p.thick=2
       !p.charthick=5
       !p.charthick=5
...
contour,1000.*wstar,lat,zlev,levels=10+10*findgen(20),c_color=0,/follow,/overplot,c_labels=1+0*level,thick=3
contour,1000.*wstar,lat,zlev,levels=-200+10*findgen(20),c_color=mcolor,/follow,/overplot,c_labels=1+0*level,thick=3
contour,1000.*wstar,lat,zlev,levels=[1,5],c_color=0,/follow,/overplot,c_labels=1+0*level,thick=3
contour,1000.*wstar,lat,zlev,levels=[-5,-1],c_color=mcolor,/follow,/overplot,c_labels=1+0*level,thick=3
imin=min(level)
imax=max(level)
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim yz_sdwaccm_tbar_RC_'+sdate+'.ps -rotate -90 yz_sdwaccm_tbar_RC_'+sdate+'.jpg'
endif

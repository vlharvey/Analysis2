;
; save multi-year monthly means of WACCM Surface Area Density of sulf
...
for imon=0L,nmon-1L do begin
    ...
    dir='/aura7/harvey/CCMval_data/Datfiles/CCMVal2_REF-B1_WACCM_1_T3I_sad_sulf_????'+smon(imon)+'??.sav'
    ...
    for ifile=0L,nfile-1L do begin
        ...
        if index(0) ne -1L then begin
           wsadgrd(index)=wsadgrd(index)+sadgrd(index)/100.	; cm-1 to m-1
...
; save monthly mean
;
    save,file='/aura7/harvey/CCMval_data/Datfiles/CCMVal2_REF-B1_WACCM_1_T3I_sad_sulf_'+smon(imon)+'.sav',$
          alon,alat,lev,wsadgrd,nwsadgrd
    print,'saved CCMVal2_REF-B1_WACCM_1_T3I_sad_sulf_'+smon(imon)+'.sav'
endfor
end

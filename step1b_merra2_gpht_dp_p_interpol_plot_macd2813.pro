...
dum1=file_search(dirw+'2018??????.sav',count=count1)		; works for 2010-2019
...
save,filename=dirw+'press_'+sdate+'.sav',LATITUDE_WACCM,LONGITUDE_WACCM,PRESSURE,PSGRD,O3GRD,QVGRD,TGRD,UGRD,VGRD,ZGRD
jumpfile:

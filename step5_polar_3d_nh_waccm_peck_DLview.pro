...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='Figures/'+ifile+'_nh_peck.ps'
       device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim Figures/'+ifile+'_nh_peck.ps -rotate -90 Figures/'+ifile+'_nh_peck.jpg'
       spawn,'/usr/bin/rm Figures/'+ifile+'_nh_peck.ps'
    endif

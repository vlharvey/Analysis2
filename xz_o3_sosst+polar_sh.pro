...
ifile='                             '
lstmn=4 & lstdy=1 & lstyr=2006 & lstday=0
ledmn=11 & leddy=30 & ledyr=2007 & ledday=0
...
print,iyr,imn,idy
print,norbits3,norbits2,norbitp,norbith,norbiti,norbita
;
...
;
      if setplot eq 'ps' then begin
         ...
         device,/landscape,bits=8,$
                 filename='XZ_Ozone/xz_o3_sosst+polar_sh_'+lfile+'_'+stheta+'K.ps'
         device,/color
...
;         if index(0) ne -1 then oplot,xz2d(index),yz2d(index),psym=3,color=mcolor
      ...
      if setplot eq 'ps' then begin
         device, /close
         spawn,'convert -trim XZ_Ozone/xz_o3_sosst+polar_sh_'+lfile+'_'+stheta+'K.ps -rotate -90 '+$
               ' XZ_Ozone/xz_o3_sosst+polar_sh_'+lfile+'_'+stheta+'K.jpg'
         spawn,'/usr/bin/rm XZ_Ozone/xz_o3_sosst+polar_sh_'+lfile+'_'+stheta+'K.ps'
      endif
      icount=icount+1L
      goto,jump
end

...
restore,ifiles(0)
hlatpdf_time_all=reform(hlatpdf_time_3d(*,*,16))
llatpdf_time_all=reform(llatpdf_time_3d(*,*,16))
lowlat_elatedge_time_all=reform(LOWLAT_ELATEDGE_2d(*,16))
...
for ifile=1L,n_elements(ifiles)-1L do begin
    ...
    print,ifiles(ifile)
    hlatpdf_time_all=[hlatpdf_time_all,reform(hlatpdf_time_3d(*,*,16))]
    llatpdf_time_all=[llatpdf_time_all,reform(llatpdf_time_3d(*,*,16))]
    LOWLAT_ELATEDGE_TIME_all=[LOWLAT_ELATEDGE_TIME_all,reform(LOWLAT_ELATEDGE_2d(*,16))]

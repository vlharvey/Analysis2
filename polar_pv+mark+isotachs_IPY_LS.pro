...
;        read,'Enter theta ',theta
      ...
      if setplot eq 'ps' then begin
         ...
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
                /bold,/color,bits_per_pixel=8,/times,filename='Figures/polar_sh_'+sdate+stime(itime)+'_PV_LS.ps'
         !p.charsize=1.25
         !p.thick=2
         !p.charthick=5
         !y.thick=2
...
;     contour,pv,x,alat,/overplot,levels=level,c_color=col1,/fill,/noeras
      contour,pv,x,alat,/overplot,levels=level,/follow,c_labels=0*level,/noeras,color=0,thick=3
;
...
loadct,0
      ...
      if setplot eq 'ps' then begin
         device, /close
         spawn,'convert -trim Figures/polar_sh_'+sdate+stime(itime)+'_PV_LS.ps -rotate -90 Figures/polar_sh_'+sdate+stime(itime)+'_PV_LS.png'
         spawn,'rm -f Figures/polar_sh_'+sdate+stime(itime)+'_PV_LS.ps'
      endif

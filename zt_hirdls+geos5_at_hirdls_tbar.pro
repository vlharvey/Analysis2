...
for j=29L,34L do begin
    ...
    if setplot eq 'ps' then begin
       ...
       device,font_size=9
       device,/landscape,bits=8,filename='zt_hirdls+geos5_at_hirdls_tbar_'+slat+'.ps'
       device,/color
...
jump:
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert -trim zt_hirdls+geos5_at_hirdls_tbar_'+slat+'.ps -rotate -90 zt_hirdls+geos5_at_hirdls_tbar_'+slat+'.jpg'
    endif

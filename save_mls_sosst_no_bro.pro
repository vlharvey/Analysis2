...
;
lstmn=2L & lstdy=13L & lstyr=5L
ledmn=2L & leddy=13L & ledyr=5L
lstday=0L & ledday=0L 
...
;
      if result2(0) eq 0L or result3(0) eq 0L or result4(0) eq 0L or $
...
;
      bromls=-99.+0.*transpose(bro.L2GPVALUE)
      broprecision=-99.+0.*transpose(bro.L2GPPRECISION)

;
; nc5 version where circumpolar highs are marked
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='polar_3d_nh_waccm3_'+sdate+'_DL+highs_nc5.ps'
   device,/color
...
jumplev:
    ...
    !psym=0
    xyouts,0.3,0.875,'WACCM3 Arctic Vortex',/normal,charsize=3,color=0,charthick=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim polar_3d_nh_waccm3_'+sdate+'_DL+highs_nc5.ps -rotate -90 '+$
                           'polar_3d_nh_waccm3_'+sdate+'_DL+highs_nc5.jpg'
       spawn,'/usr/bin/rm -f polar_3d_nh_waccm3_'+sdate+'_DL+highs_nc5.ps'
    endif

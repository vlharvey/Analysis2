pro write_waccm_nc3,ofile,nlg,nlat,nth,alon,alat,thlev,$
          ipv,prs,u,v,qdf,mark,vp,sf,o3,ch4,noy
...
noyid  = ncdf_vardef(ncid, 'noy'       , [latdimid,londimid,levdimid])
...
ncdf_varput, ncid, noyid , noy  , COUNT=[nlat,nlg,nth]
ncdf_close,ncid
return
end

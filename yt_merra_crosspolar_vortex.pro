...
contour,merravortex_yt,1.+findgen(kday),alat,/noeras,xrange=[1.,kday],yrange=[-90.,90.],$
      charsize=1.5,color=0,ytitle='Latitude',/cell_fill,c_color=col1,title=yearlab+' MERRA Arctic Vortex '+stheta+' K',$
      levels=level,yticks=6,xticks=nxticks-1,xtickname=xlabs,xtickv=xindex,min_value=-99.,$
...
;contour,merravortex_yt,1.+findgen(kday),alat,levels=[-0.99,0.99],c_color=[0,200],/follow,/overplot,thick=7

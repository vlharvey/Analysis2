...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename=odir(0)+'polar_3d_sh_geos5_meto_'+date+'_DL+highs_nc4.ps'
   device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim '+odir(0)+'polar_3d_sh_geos5_meto_'+date+'_DL+highs_nc4.ps -rotate -90 '+$
                              odir(0)+'polar_3d_sh_geos5_meto_'+date+'_DL+highs_nc4.jpg'
    endif
goto, jump
end

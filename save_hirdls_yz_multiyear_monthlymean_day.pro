...
;
; eliminate data where the solar zenith angle is greater than 80. (night)
;
        xindex=where(zangle gt 80.)
        if xindex(0) ne -1L then begin
           tpmask(xindex,*)=-99.
           no2mask(xindex,*)=-99.
           o3mask(xindex,*)=-99.
        endif
...
;
    save,file=dir+mon(m)+'avg_yth_'+ver+'_day.sav',nr,nth,alat,th,$

...
DEVICE,/BOLD
DEVICE, FILENAME=ptho+'xt_cips_3c_'+season+'_'+snode+'_'+slat+'Lat_'+G+'G_freq.ps'
endif
...
!type=2^2+2^3+2^6
plot,[imin,imax],[0,0],yrange=[0,10],xrange=[imin,imax],color=0,xtitle='CIPS Frequency V4.20 Rev05'
ybox=[0,10,10,0,0]
x1=imin
...
if setplot eq 'ps' then begin
DEVICE,/CLOSE
spawn,'convert -trim xt_cips_3c_'+season+'_'+snode+'_'+slat+'Lat_'+G+'G_freq.ps -rotate -90 xt_cips_3c_'+season+'_'+snode+'_'+slat+'Lat_'+G+'G_freq.png'
endif
;
; save data 
;
xtfreq=array
save,file='xt_cips_3c_'+season+'_'+snode+'_'+slat+'Lat_'+G+'G_freq.sav',xtfreq,lonbin,ddd

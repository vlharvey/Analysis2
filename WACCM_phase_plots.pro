...
for iES = 0L, n_elements(dayzeros) - 1L do begin
	...
	plot,/ylog,phase60[inday,*], pressure_grid,position=[.001,.001,.999,.999],xrange = [0,360],yrange = [100,.001], psym = 2,symsize = 2,xstyle = $

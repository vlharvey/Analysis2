pro write_waccm3_nc3_bardeen_dust,ofile,nlg,nlat,nth,alon,alat,thlev,$
          ipv,prs,u,v,qdf,mark,vp,sf,q,dust_ad,dust_md,dust_mmr,dust_nd,dust_re
...
qid    = ncdf_vardef(ncid, 'spec_hum'  , [latdimid,londimid,levdimid])
d1id   = ncdf_vardef(ncid, 'dust_ad'  , [latdimid,londimid,levdimid])
d2id   = ncdf_vardef(ncid, 'dust_md'  , [latdimid,londimid,levdimid])
d3id   = ncdf_vardef(ncid, 'dust_mmr' , [latdimid,londimid,levdimid])
d4id   = ncdf_vardef(ncid, 'dust_nd'  , [latdimid,londimid,levdimid])
d5id   = ncdf_vardef(ncid, 'dust_re'  , [latdimid,londimid,levdimid])
...
ncdf_varput, ncid, d1id  , dust_ad , COUNT=[nlat,nlg,nth]
ncdf_varput, ncid, d2id  , dust_md , COUNT=[nlat,nlg,nth]
ncdf_varput, ncid, d3id  , dust_mmr, COUNT=[nlat,nlg,nth]
ncdf_varput, ncid, d4id  , dust_nd , COUNT=[nlat,nlg,nth]
ncdf_varput, ncid, d5id  , dust_re , COUNT=[nlat,nlg,nth]
ncdf_close,ncid
return
end

...
contour,gmarklat(*,*,0),1+findgen(12),alat,/nodata,/noeras,xrange=[1.,12.],yrange=[-90.,-20.],charsize=2,color=0,/cell_fill,c_color=col1,$
      ytitle='Latitude',xticks=n_elements(xlab)-1,xtickname=xlab,title='Antarctic Vortex '+sth,levels=level

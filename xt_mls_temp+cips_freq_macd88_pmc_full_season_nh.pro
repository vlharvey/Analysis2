...
xyouts,xmn+0.01,ymx-0.05,yearlab,/normal,charsize=3,color=0,charthick=2
loadct,39

contour,smooth(cipsfreq,5,/NaN,/edge_truncate),lonbin,ddd,levels=[1],color=0,/overplot,/noeras,$
        c_charsize=2,c_labels=[1],thick=10
loadct,0
;contour,smooth(cipsfreq,5,/NaN,/edge_truncate),lonbin,ddd,levels=[5],color=0.1*mcolor,/overplot,/noeras,c_charsize=2,c_labels=[1],thick=10

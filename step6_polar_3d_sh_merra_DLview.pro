...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='Antarctic_3D/'+ifile+'_3D.ps'
       device,/color
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim Antarctic_3D/'+ifile+'_3D.ps -rotate -90 Antarctic_3D/'+ifile+'_3D.jpg'
       spawn,'rm -f Antarctic_3D/'+ifile+'_3D.ps'
    endif

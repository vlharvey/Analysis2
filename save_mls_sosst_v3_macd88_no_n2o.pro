...
;
restore,'/Volumes/earth/aura6/data/MLS_data/Datfiles_SOSST/o3_mls_v3.3_20040921.sav
;restore,'/aura3/data/SAGE_II_data/Datfiles_SOSST/altitude.sav'
nz=n_elements(altitude)
;
; enter dates to convert MLS pressure data
;
lstmn=10L & lstdy=1L & lstyr=2008L
ledmn=5L & leddy=30L & ledyr=2009L
lstday=0L & ledday=0L 
...
;     n2omask=0.*n2omls
      n2omls=-99.+0.*hno3mls
      n2oprecision=0.*n2omls
      n2ostatus=0.*n2omls
      n2oquality=0.*n2omls
      n2oconvergence=0.*n2omls
      n2omask=0.*n2omls
...
;
      ...
      if index(0) ne -1L then begin
         ...
         brostatus=reform(brostatus(index))
         broquality=reform(broquality(index))
         broconvergence=reform(broconvergence(index))
...
;
      ...
      save,file=rawfile,pmls,pmls2,time,fdoy,latitude,longitude,fdoy,bromls,broprecision,bromask,o3mls,o3precision,o3mask,$

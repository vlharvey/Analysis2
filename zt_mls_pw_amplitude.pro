...
;
      mlspw1_zt(icount,*)=reform(MLSWAVE1HEIGHT(ilat,*))
;
...
zlevel=100*findgen(20)
nlvls2=n_elements(zlevel)
col2=70+indgen(nlvls2)*icolmax/(nlvls2+1)
loadct,0
contour,smooth(mlspw1_zt,3,/edge_truncate,/Nan),1.+findgen(kday),pressure_altitude,/overplot,levels=zlevel,c_color=col2,thick=4
loadct,39

...
ifile='                             '
lstmn=2 & lstdy=23 & lstyr=5 & lstday=0
ledmn=2 & leddy=23 & ledyr=5 & ledday=0
;
...
;
      if setplot eq 'ps' then begin
         ...
         device,/landscape,bits=8,$
                 filename='xz_o3_soundings+polar_nh_'+lfile+'_'+stheta+'K.ps'
         device,/color
...
;         if index(0) ne -1 then oplot,xz2d(index),yz2d(index),psym=3,color=mcolor
      ...
      if norbitp3 gt 0L then begin
         ...
         index=where(abs(thpoam3-rtheta) le 50. and o3poam3 gt 0. and ypoam2d gt 0.,pcount)
      ...
      if setplot eq 'ps' then begin
         device, /close
         spawn,'convert -trim xz_o3_soundings+polar_nh_'+lfile+'_'+stheta+'K.ps -rotate -90 '+$
               ' xz_o3_soundings+polar_nh_'+lfile+'_'+stheta+'K.jpg'
      endif
      icount=icount+1L
      goto,jump
end

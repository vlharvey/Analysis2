...
;
      if setplot eq 'ps' then begin
         ...
         !p.font=0
         device,font_size=9
         device,/landscape,bits=8,filename='scatter_geos5_co+mark_60-90N_composite.ps'
         device,/color
...
plot,plotarray2,plotarray,psym=8,/noeras,charsize=2,charthick=2,xrange=[0,7],yrange=[1,7],min_value=-9999.,ytitle='MLS CO (ppmv)',xtitle='MLS H2O (ppmv)',color=0,symsize=0.5,title='60N-90N at 3000 K'	;,/nodata
...
if setplot eq 'ps' then begin
   device,/close
   spawn,'convert -trim scatter_geos5_co+mark_60-90N_composite.ps -rotate -90 '+$
         'scatter_geos5_co+mark_60-90N_composite.jpg'
endif

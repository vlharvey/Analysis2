;-----------------------------------------------------------------------------------------------------------------------------
; Reads in WACCM data and plots zonal and meridional phase of the Arctic vortex (tilt with altitude) after 4th ES event
;	 -------------------------------
;       |         Lynn Harvey           |
;       |         LASP, ATOC            |
...
for iES = 3L, 3 do begin	;n_elements(dayzeros) - 1L do begin
...
;
        ...
        if icount eq 0L then begin
           plot,xphase,theta,color=0,xtitle='Longitude',xrange=[-270.,90.],thick=6,yrange=[500.,9000.],xticks=3,/noeras
           oplot,[dailymaxheightlon[iES,iday],dailymaxheightlon[iES,iday]],$

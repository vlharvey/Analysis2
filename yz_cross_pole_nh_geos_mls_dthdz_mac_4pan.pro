...
;
    ...
    if setplot eq 'ps' then begin
       ...
       ysize=nydim/100.
       set_plot,'ps'
       device,/color,/landscape,bits=8,filename='yz_cross_pole_geos_nh_geos_mls_temp_dthdz_'+sdate+'_'+slon1+'_4pan.ps'
...
;   xyouts,.4,.95,'GEOS-5 '+sdate,/normal,color=0,charsize=3
    ...
    contour,tyz,alat,th,levels=level,/cell_fill,c_color=col1,color=0,title='GEOS-5 Temp',$
            ytitle='Theta',xtickname=['Eq','30','60','NP','60','30','Eq'],xticks=6,yrange=[500.,4600.],charsize=1.5
...
;   contour,markyz,alat,th,levels=[0.1],color=0,thick=5,/overplot
      ...
      plot,[0,0],[imin,imax],xrange=[0,10],yrange=[imin,imax],title='K',color=0,xticks=4
      xbox=[0,10,10,0,0]
      y1=imin
    ...
    contour,dthdzyz,alat,th,levels=level,/cell_fill,c_color=col1,color=0,title='MLS Temp',$
            ytickname=[' ',' ',' ',' ',' ',' ',' ',' '],$
            xtickname=['Eq','30','60','NP','60','30','Eq'],xticks=6,yrange=[500.,4600.],/nodata,charsize=1.5
...
;   contour,markyz,alat,th,levels=[0.1],color=0,thick=5,/overplot
    ...
    contour,dthdzyz,alat,th,levels=level,/cell_fill,c_color=col1,color=0,title='GEOS-5 dth/dz',$
            xtitle=slon1+'       '+slon2,ytitle='Theta',$
            xtickname=['Eq','30','60','NP','60','30','Eq'],xticks=6,yrange=[500.,4600.],charsize=1.5
...
;   contour,markyz,alat,th,levels=[0.1],color=0,thick=5,/overplot
      ...
      !type=2^2+2^3+2^5+2^7
      plot,[0,0],[imin,imax],xrange=[0,10],yrange=[imin,imax],title='K/km',color=0,xticks=4
      xbox=[0,10,10,0,0]
      y1=imin
      dy=(imax-imin)/float(nlvls)
      for j=0,nlvls-1 do begin
...
; Close PostScript file and return control to X-windows
     ...
     if setplot eq 'ps' then begin
        device, /close
        spawn,'convert -trim yz_cross_pole_geos_nh_geos_mls_temp_dthdz_'+sdate+'_'+slon1+'_4pan.ps -rotate -90 '+$
                            'yz_cross_pole_geos_nh_geos_mls_temp_dthdz_'+sdate+'_'+slon1+'_4pan.jpg'
        spawn,'/usr/bin/rm yz_cross_pole_geos_nh_geos_mls_temp_dthdz_'+sdate+'_'+slon1+'_4pan.ps'
     endif
     jumpday:
goto,jump
end

...
lstmn=1L & lstdy=26L & lstyr=2007L
...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='polar_3d_sh_waccm3_'+sdate+'_DL+highs_nc5.ps'
   device,/color
...
;          contour,temp,xcs,ycs,levels=[190.],color=0.25*mcolor,/T3D,zvalue=nz,thick=2,min_value=-1.e15
...
jumplev:
    ...
    !psym=0
    xyouts,0.275,0.875,'WACCM3 Arctic Vortex',/normal,charsize=3,color=0,charthick=2
    xyouts,0.4,0.84,'(Most Poleward Jet)',/normal,charsize=2,color=0,charthick=2
    xyouts,0.4,0.925,sdate,/normal,charsize=3,color=0,charthick=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim polar_3d_sh_waccm3_'+sdate+'_DL+highs_nc5.ps -rotate -90 '+$
                           'polar_3d_sh_waccm3_'+sdate+'_DL+highs_nc5.jpg'
       spawn,'/usr/bin/rm -f polar_3d_sh_waccm3_'+sdate+'_DL+highs_nc5.ps'
    endif

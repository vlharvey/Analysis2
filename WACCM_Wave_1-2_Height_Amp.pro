...
restore, '/Volumes/MacD68-1/france/ES_paper/Post_process/Platentary_Wave_1_amplitudes.sav'
wave1t = waccmheight60
restore, '/Volumes/MacD68-1/france/ES_paper/Post_process/Platentary_Wave_2_amplitudes.sav'
wave2t = waccmheight60
waccmheight60 = wave1t+wave2t
...
waccmheight = waccmheight60[daysindex,*]
waccmstrat = waccmstratopausepole[daysindex,*]
...
xyouts, .12,.95,'WACCM 60 N GPH Wave 1-2 Amplitude - event ' + strtrim(strcompress(ies+1L),2) + ' -- ' + dates[idayzero]
...
loadct, 39
  ...
  if setplot eq 'ps' then begin
	...
	'pnmtopng idl001.ppm > /Volumes/MacD68-1/france/ES_paper/Figures/WACCM_PW_1-2_Amp_event_'+strtrim(strcompress(ies+1L),2)+'.png'

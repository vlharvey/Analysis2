...
index1=where(syear eq year1 and fdoy_all ge 121. and fdoy_all le 260. and cloud_freq_avg_nhlat ge 0.1)
;print,latbin(ilat),n_elements(index1)
if n_elements(index1) ge 5L then begin
;print,sdate_all(index1)
   cfreqnew=cloud_freq_avg_nhlat(index1)
   fdoynew=fdoy_all(index1)-91.	; fdoy=0 on april 1

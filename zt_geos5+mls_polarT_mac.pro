...
ymx=yorig(2)+ylen
set_viewport,xmn,xmx,ymn,ymx
contour,mls_temp_nh_zt,findgen(kday),th,charsize=2,/noeras,yrange=[300.,max(th)],charthick=2,$
...
ymx=yorig(3)+ylen
set_viewport,xmn,xmx,ymn,ymx
contour,mls_temp_sh_zt,findgen(kday),th,charsize=2,/noeras,yrange=[300.,max(th)],charthick=2,$
...
;  spawn,'/usr/bin/rm zt_geos5+mls_polarT.ps'
;endif
end

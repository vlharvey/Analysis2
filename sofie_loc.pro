...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='sofie_loc.ps'
   !p.thick=2
   !p.charthick=5
   !y.thick=2
   !x.thick=2
...
;       '2004','2005']	;,'2006']
syear=['2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017']
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim sofie_loc.ps -rotate -90 sofie_loc.jpg'
endif
end

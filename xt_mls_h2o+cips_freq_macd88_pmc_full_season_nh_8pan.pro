...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='xt_mls_h2o+cips_freq_8pan_'+slat+'_pmc_full_season.ps'
   !p.charsize=1.5
   !p.thick=2
   !p.charthick=5
   !y.thick=2
...
x1=x1+dx
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert -trim xt_mls_h2o+cips_freq_8pan_'+slat+'_pmc_full_season.ps -rotate -90 xt_mls_h2o+cips_freq_8pan_'+slat+'_pmc_full_season.png'
    endif

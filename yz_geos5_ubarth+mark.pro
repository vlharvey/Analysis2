...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='Figures/yz_geos5_ubarth+mark_'+sdate+'.ps'
   device,/color
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim Figures/yz_geos5_ubarth+mark_'+sdate+'.ps -rotate -90 Figures/yz_geos5_ubarth+mark_'+sdate+'.jpg'
   spawn,'/usr/bin/rm Figures/yz_geos5_ubarth+mark_'+sdate+'.ps'
endif

...
; save and plot time-altitude section of vortex CO
;
@fillit
@smoothit
...
if setplot eq 'ps' then begin
   ...
   ysize=nydim/100.
   device,font_size=9
   device,/landscape,bits=8,filename='zt_ace_co_spring_6pan_sh.ps'
   device,/color
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim zt_ace_co_spring_6pan_sh.ps -rotate -90 zt_ace_co_spring_6pan_sh.jpg'
endif
end

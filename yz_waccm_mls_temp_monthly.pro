...
if setplot eq 'ps' then begin
   ...
   !p.font=0
   device,font_size=9
   device,/landscape,bits=8,filename='yz_waccm_mls_temp_'+syear+smonth+'.ps'
   device,/color
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim yz_waccm_mls_temp_'+syear+smonth+'.ps -rotate -90 yz_waccm_mls_temp_'+syear+smonth+'.jpg'
endif
endfor	; loop over months
end

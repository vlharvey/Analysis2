...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='yz_dzdt_'+sdate+'_'+slev0+'_waccm_Traject_4pan.ps'
       device,/color
...
;velovect,u,v,x,alat,color=0,/overplot,length=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim yz_dzdt_'+sdate+'_'+slev0+'_waccm_Traject_4pan.ps -rotate -90 yz_dzdt_'+sdate+'_'+slev0+'_waccm_Traject_4pan.jpg'
       spawn,'rm -f yz_dzdt_'+sdate+'_'+slev0+'_waccm_Traject_4pan.ps'
    endif
jumplev:

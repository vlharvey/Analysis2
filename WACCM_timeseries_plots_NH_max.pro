...
loadct, 39
  ...
  if setplot eq 'ps' then begin
	...
	'pnmtopng idl001.ppm > /Volumes/MacD68-1/france/WACCM_paper/Figures/timeseries/WACCM_maxtemp_timeseries_NH_20' + string(FORMAT='(I2.2)',iyear2) + '.png'

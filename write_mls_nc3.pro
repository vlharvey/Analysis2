pro write_mls_nc3,ofile,nlg,nlat,nth,alon,alat,thlev,$
          ipv,prs,u,v,qdf,mark,co,z,sf,h2o,markco
...
qvid   = ncdf_vardef(ncid, 'co'        , [latdimid,londimid,levdimid])
zid    = ncdf_vardef(ncid, 'gph'       , [latdimid,londimid,levdimid])
stfid  = ncdf_vardef(ncid, 'strm'      , [latdimid,londimid,levdimid])
qid    = ncdf_vardef(ncid, 'h2o'       , [latdimid,londimid,levdimid])
m2id   = ncdf_vardef(ncid, 'markco'    , [latdimid,londimid,levdimid])
...
ncdf_varput, ncid, qvid  , co   , COUNT=[nlat,nlg,nth]
ncdf_varput, ncid, zid   , z    , COUNT=[nlat,nlg,nth]
ncdf_varput, ncid, stfid , sf   , COUNT=[nlat,nlg,nth]
ncdf_varput, ncid, qid   , h2o  , COUNT=[nlat,nlg,nth]
ncdf_varput, ncid, m2id  , markco, COUNT=[nlat,nlg,nth]
ncdf_close,ncid
return
end

;
; Hovmoller of MLS temperature 1 Nov to 1 Mar
...
axis,yaxis=1,xaxis=1,xrange=[0.,360.],yrange=[70,-51.],/save,charsize=2,color=0,charthick=2,ytitle='DFS'             ; 11/1 to 3/1
...
!type=2^2+2^3+2^6
plot,[imin,imax],[0,0],yrange=[0,10],xrange=[imin,imax],color=0,xtitle='MLS Temperature (K) '+slat+'S/'+salt+'km',charsize=1.5,charthick=2
ybox=[0,10,10,0,0]
x1=imin

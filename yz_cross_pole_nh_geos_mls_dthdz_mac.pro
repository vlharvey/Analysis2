...
dir='/Users/harvey/GEOS5_data/Datfiles/DAS.ops.asm.tavg3d_dyn_v.GEOS520.MetO.'
...
;
    ...
    if setplot eq 'ps' then begin
       ...
       ysize=nydim/100.
       set_plot,'ps'
       device,/color,/landscape,bits=8,filename='yz_cross_pole_geos_nh_'+sdate+'_'+slon1+'_15pan+mlsh2o+temp.ps'
...
; Close PostScript file and return control to X-windows
     ...
     if setplot eq 'ps' then begin
        device, /close
        spawn,'convert -trim yz_cross_pole_geos_nh_'+sdate+'_'+slon1+'_15pan+mlsh2o+temp.ps -rotate -90 '+$
                            'yz_cross_pole_geos_nh_'+sdate+'_'+slon1+'_15pan+mlsh2o+temp.jpg'
        spawn,'/usr/bin/rm yz_cross_pole_geos_nh_'+sdate+'_'+slon1+'_15pan+mlsh2o+temp.ps'
     endif
     jumpday:
goto,jump
end

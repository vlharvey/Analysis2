...
; add white box around title text
  ...
  thisDevice = !D.Name
	...
	xsize = 4000
	ysize = 350
	Device, Decomposed=0, Set_Pixel_Depth=24, Set_Resolution=[xsize,ysize],set_font=arial
;	Set_Plot, thisDevice
...
loadct,0
  ...
  position = [.01,.01,.9,.9], xstyle=5,ystyle=5, color = 0, /nodata,background = 0
  ...
  contour, latitude, xarray,yarray,levels = [-80,-60,-50,-40,-30,-20,-10,10,20,30,40,50,60,80],c_linestyle = 0, /follow, /overplot,color = 250,$
     c_charsize = 2, c_thick = 3,C_Labels=Replicate(1, 13),c_charthick = 4
  contour, latitude, xarray,yarray,levels = [-90,-80,-70,-60,-50,-40,-30,-20,-10,10,20,30,40,50,60,70,80,90],c_linestyle = 0, /overplot,color = 250,$
       c_charsize = 2, c_thick = 3,C_Labels=Replicate(0, 19),c_charthick = 4
  contour, latitude, xarray,yarray,levels = [0],c_linestyle = 0, /follow, /overplot,color = 250, c_charsize = 2, c_thick = 6,C_Labels=[0],C_annot = ['Eq'],c_charthick = 4
  contour, xlons, xarray,yarray,levels = findgen(37)*10.,c_linestyle = 0, /follow, /overplot,color = 250, c_charsize = 2, c_thick =3,c_charthick = 4
  contour, longitude, xarray,yarray,levels = findgen(37)*10.,c_linestyle = 0, /overplot,color = 250, c_charsize = 0, c_thick =3,C_Labels=Replicate(0, 36),c_charthick = 4
  contour, longitude, xarray,yarray,levels = [360],c_linestyle = 0, /overplot,color = 250, c_charsize = 0, c_thick =3,C_Labels=Replicate(0, 1),c_charthick = 4
  contour, longitude, xarray,yarray,levels = [0],c_linestyle = 0, /overplot,color = 250, c_charsize = 0, c_thick =3,C_Labels=Replicate(0, 1),c_charthick = 4
  contour,continent_plot,xarray, yarray,/fill,level = [0,.85], c_color = [0,150],$
...
loadct,0
	plot,[0,0],[0,1],xrange=[0,1],yrange=[0,1],/noeras,/nodata,$
	  xstyle=4,ystyle = 4,position = [.01,.9, .9,.99]
	xbox=[0,1,1,0,0]
	ybox=[0,0,1,1,0]
	...
	xyouts, .5,.1,plot_title, align = .5, charsize = 2.5, color = 0, charthick = 5
	...
	xyouts, .94,.5,'Rayleigh Albedo Anomaly (%)', orientation = 90, align = .5, charsize = 1.5, color = 0, charthick = 3
...
;	slabcolor[-4:-1] = 255
 ...
 ; convert .ps to png and save image and thumbnail
	;device, /close
  write_png,RAA_Plot_filename ,tvrd(/true)
